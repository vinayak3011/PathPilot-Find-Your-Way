...
class MaleRestroom2 extends StatefulWidget {
  static String routeName = "MaleRestroom2";
  const MaleRestroom2({super.key,int? currentindex});

  @override
  State<MaleRestroom2> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MaleRestroom2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase2/map2+male+restroomblend.glb',
          ),
        ),
      ),
    );
