...
class FemaleRestroom2 extends StatefulWidget {
  static String routeName = "FemaleRestroom2";
  const FemaleRestroom2({super.key,int? currentindex});

  @override
  State<FemaleRestroom2> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<FemaleRestroom2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase2/map2+female+restroom.glb',
          ),
        ),
      ),
    );
