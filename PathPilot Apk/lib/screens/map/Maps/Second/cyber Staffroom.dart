...
class CyseStaffroom2 extends StatefulWidget {
  static String routeName = "CyseStaffroom2";
  const CyseStaffroom2({super.key,int? currentindex});

  @override
  State<CyseStaffroom2> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<CyseStaffroom2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase2/map2+cyse+staff+room.glb',
          ),
        ),
      ),
    );
