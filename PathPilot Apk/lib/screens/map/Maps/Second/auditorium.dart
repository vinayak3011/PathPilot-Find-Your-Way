...
class Auditorium2 extends StatefulWidget {
  static String routeName = "Auditorium2"
      ;
  const Auditorium2({super.key,int? currentindex});

  @override
  State<Auditorium2> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Auditorium2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase2/map2+auditorium.glb',
          ),
        ),
      ),
    );
