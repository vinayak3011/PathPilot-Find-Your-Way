...
class Library2 extends StatefulWidget {
  static String routeName = "Library2";
  const Library2({super.key,int? currentindex});

  @override
  State<Library2> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Library2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase2/map2+library.glb',
          ),
        ),
      ),
    );
