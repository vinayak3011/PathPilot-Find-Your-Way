...
class OrangeRoom2 extends StatefulWidget {
  static String routeName = "OrangeRoom2"
  ;
  const OrangeRoom2({super.key,int? currentindex});

  @override
  State<OrangeRoom2> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<OrangeRoom2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase2/map2+orange+room.glb',
          ),
        ),
      ),
    );
