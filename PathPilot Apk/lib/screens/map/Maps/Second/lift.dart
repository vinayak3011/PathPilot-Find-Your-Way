...
class Lift2 extends StatefulWidget {
  static String routeName = "Lift2"
  ;
  const Lift2({super.key,int? currentindex});

  @override
  State<Lift2> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Lift2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase2/map2+lift.glb',
          ),
        ),
      ),
    );
