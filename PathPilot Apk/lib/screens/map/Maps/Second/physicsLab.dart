...
class PhysicsLab2 extends StatefulWidget {
  static String routeName = "PhysicsLab2";
  const PhysicsLab2({super.key,int? currentindex});

  @override
  State<PhysicsLab2> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<PhysicsLab2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase2/map2+physics+lab.glb',
          ),
        ),
      ),
    );
