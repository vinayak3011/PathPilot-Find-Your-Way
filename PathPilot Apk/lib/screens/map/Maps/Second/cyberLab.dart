...
class CyseLab2 extends StatefulWidget {
  static String routeName = "CyseLab2";
  const CyseLab2({super.key,int? currentindex});

  @override
  State<CyseLab2> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<CyseLab2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase2/map2+cyse+lab+402.glb',
          ),
        ),
      ),
    );
