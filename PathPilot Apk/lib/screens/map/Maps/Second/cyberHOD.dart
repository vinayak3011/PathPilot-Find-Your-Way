...
class CyseHOD2 extends StatefulWidget {
  static String routeName = "CyseHOD2";
  const CyseHOD2({super.key,int? currentindex});

  @override
  State<CyseHOD2> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<CyseHOD2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase2/map2+hod+cyse.glb',
          ),
        ),
      ),
    );
