...
class Auditorium3 extends StatefulWidget {
  static String routeName = "Auditorium3"
      ;
  const Auditorium3({super.key,int? currentindex});

  @override
  State<Auditorium3> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Auditorium3> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase3/map3+to+auditorium.glb',
          ),
        ),
      ),
    );
