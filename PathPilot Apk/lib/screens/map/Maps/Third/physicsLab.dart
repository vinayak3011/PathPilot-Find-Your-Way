...
class PhysicsLab3 extends StatefulWidget {
  static String routeName = "PhysicsLab3";
  const PhysicsLab3({super.key,int? currentindex});

  @override
  State<PhysicsLab3> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<PhysicsLab3> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase3/map3+to+physics+lab.glb',
          ),
        ),
      ),
    );
