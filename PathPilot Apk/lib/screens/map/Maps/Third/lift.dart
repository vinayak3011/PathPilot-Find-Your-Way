...
class Lift3 extends StatefulWidget {
  static String routeName = "Lift3"
  ;
  const Lift3({super.key,int? currentindex});

  @override
  State<Lift3> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Lift3> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase3/map3+to+lift.glb',
          ),
        ),
      ),
    );
