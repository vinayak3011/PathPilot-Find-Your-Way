...
class Library3 extends StatefulWidget {
  static String routeName = "Library3";
  const Library3({super.key,int? currentindex});

  @override
  State<Library3> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Library3> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase3/map3+to+library+.glb',
          ),
        ),
      ),
    );
