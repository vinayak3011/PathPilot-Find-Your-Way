...
class OrangeRoom3 extends StatefulWidget {
  static String routeName = "OrangeRoom3"
  ;
  const OrangeRoom3({super.key,int? currentindex});

  @override
  State<OrangeRoom3> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<OrangeRoom3> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase3/map3+to+orange+room.glb',
          ),
        ),
      ),
    );
