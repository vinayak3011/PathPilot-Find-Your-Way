...
class Map3 extends StatefulWidget {
  static String routeName = "map3";
  const Map3({super.key,int? currentindex});

  @override
  State<Map3> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Map3> {
        ...
        child: Container(
          ...
          height: MediaQuery.of(context).size.height,
            child: Flutter3DViewer(
              ...
              src: 'assets/StairCase3/Map3.glb',
            ),
          ),
        ),
      );
