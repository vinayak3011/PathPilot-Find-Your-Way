...
class CyseHOD3 extends StatefulWidget {
  static String routeName = "CyseHOD3";
  const CyseHOD3({super.key,int? currentindex});

  @override
  State<CyseHOD3> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<CyseHOD3> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase3/map3+to+hod+cyse.glb',
          ),
        ),
      ),
    );
