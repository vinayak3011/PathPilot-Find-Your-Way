...
class MaleRestroom3 extends StatefulWidget {
  static String routeName = "MaleRestroom3";
  const MaleRestroom3({super.key,int? currentindex});

  @override
  State<MaleRestroom3> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MaleRestroom3> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase3/map3+to+male+restroom.glb',
          ),
        ),
      ),
    );
