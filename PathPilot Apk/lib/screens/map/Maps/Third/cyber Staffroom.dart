...
class CyseStaffroom3 extends StatefulWidget {
  static String routeName = "CyseStaffroom3";
  const CyseStaffroom3({super.key,int? currentindex});

  @override
  State<CyseStaffroom3> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<CyseStaffroom3> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase3/map3+to+cyse+staff+room.glb',
          ),
        ),
      ),
    );
