...
class FemaleRestroom3 extends StatefulWidget {
  static String routeName = "FemaleRestroom3";
  const FemaleRestroom3({super.key,int? currentindex});

  @override
  State<FemaleRestroom3> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<FemaleRestroom3> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase3/map3+to+female+restroom.glb',
          ),
        ),
      ),
    );
