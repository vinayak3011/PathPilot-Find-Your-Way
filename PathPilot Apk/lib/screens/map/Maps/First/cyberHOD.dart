...
class CyseHOD1 extends StatefulWidget {
  static String routeName = "CyseHOD1";
  const CyseHOD1({super.key,int? currentindex});

  @override
  State<CyseHOD1> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<CyseHOD1> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase1/map1+to+hod+cyse.glb',
          ),
        ),
      ),
    );
