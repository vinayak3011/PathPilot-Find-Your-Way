...
class Lift1 extends StatefulWidget {
  static String routeName = "Lift1"
  ;
  const Lift1({super.key,int? currentindex});

  @override
  State<Lift1> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Lift1> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase1/map1+to+lift.glb',
          ),
        ),
      ),
    );
