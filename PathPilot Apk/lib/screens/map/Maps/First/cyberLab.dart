...
class CyseLab1 extends StatefulWidget {
  static String routeName = "CyseLab1";
  const CyseLab1({super.key,int? currentindex});

  @override
  State<CyseLab1> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<CyseLab1> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase1/map1+to+cyber+lab.glb',
          ),
        ),
      ),
    );
