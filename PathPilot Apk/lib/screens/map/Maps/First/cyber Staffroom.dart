...
class CyseStaffroom1 extends StatefulWidget {
  static String routeName = "CyseStaffroom1";
  const CyseStaffroom1({super.key});

  @override
  State<CyseStaffroom1> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<CyseStaffroom1> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase1/map1_to_cyse+staff+room.glb',
          ),
        ),
      ),
    );
