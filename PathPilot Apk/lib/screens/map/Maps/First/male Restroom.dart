...
class MaleRestroom1 extends StatefulWidget {
  static String routeName = "MaleRestroom1";
  const MaleRestroom1({super.key,int? currentindex});

  @override
  State<MaleRestroom1> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MaleRestroom1> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase1/map1+to+male+restroom.glb',
          ),
        ),
      ),
    );
