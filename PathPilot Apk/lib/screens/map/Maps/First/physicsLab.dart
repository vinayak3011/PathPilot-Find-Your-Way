...
class PhysicsLab1 extends StatefulWidget {
  static String routeName = "PhysicsLab1";
  const PhysicsLab1({super.key,int? currentindex});

  @override
  State<PhysicsLab1> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<PhysicsLab1> {
      ...
      body: Center(
        child: Container(
          ...
          child: Flutter3DViewer(
            ...
            src: 'assets/StairCase1/map1+to+physics+lab.glb',
          ),
        ),
      ),
    );
