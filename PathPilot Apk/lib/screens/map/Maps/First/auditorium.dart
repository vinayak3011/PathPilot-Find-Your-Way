...
class Auditorium1 extends StatefulWidget {
  static String routeName = "Auditorium1"
      ;
  const Auditorium1({super.key,int? currentindex});

  @override
  State<Auditorium1> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Auditorium1> {
      ...
      body: Center(
          child: Container(
            ...
            child: Flutter3DViewer(
              ...
              src: 'assets/StairCase1/map1+to+auditorium.glb',
            ),
          ),
        ),
    );
